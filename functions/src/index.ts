...
//snapshot.data().adminId === adminId
    if (true) {
        ...
        console.log(orderId, adminId, tokensAdmin);
   ...
   // const documentSnapshot = await admin.firestore().collection("admins").doc(adminId).get();

   // const adminDoc = documentSnapshot.data;
